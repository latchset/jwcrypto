...
JWS_compact_4_1_3 = "{}.{}.{}".format(
    JWS_Protected_Header_4_1_2, Payload_plaintext_b64_4, JWS_Signature_4_1_2
)

JWS_general_4_1_3 = {
    "payload": Payload_plaintext_b64_4,
    "signatures": [
        {"protected": JWS_Protected_Header_4_1_2, "signature": JWS_Signature_4_1_2}
    ],
}
...
JWS_compact_4_2_3 = "{}.{}.{}".format(
    JWS_Protected_Header_4_2_2, Payload_plaintext_b64_4, JWS_Signature_4_2_2
)

JWS_general_4_2_3 = {
    "payload": Payload_plaintext_b64_4,
    "signatures": [
        {"protected": JWS_Protected_Header_4_2_2, "signature": JWS_Signature_4_2_2}
    ],
}
...
JWS_compact_4_3_3 = "{}.{}.{}".format(
    JWS_Protected_Header_4_3_2, Payload_plaintext_b64_4, JWS_Signature_4_3_2
)

JWS_general_4_3_3 = {
    "payload": Payload_plaintext_b64_4,
    "signatures": [
        {"protected": JWS_Protected_Header_4_3_2, "signature": JWS_Signature_4_3_2}
    ],
}
...
JWS_compact_4_4_3 = "{}.{}.{}".format(
    JWS_Protected_Header_4_4_2, Payload_plaintext_b64_4, JWS_Signature_4_4_2
)

JWS_general_4_4_3 = {
    "payload": Payload_plaintext_b64_4,
    "signatures": [
        {"protected": JWS_Protected_Header_4_4_2, "signature": JWS_Signature_4_4_2}
    ],
}
...
JWS_general_4_7_3 = {
    "payload": Payload_plaintext_b64_4,
    "signatures": [
        {"header": JWS_Unprotected_Header_4_7_2, "signature": JWS_Signature_4_7_2}
    ],
}
...
JWS_general_4_8_5 = {
    ...
    "signatures": [
        ...
        {"header": JWS_Unprotected_Header_4_8_3, "signature": JWS_Signature_4_8_3},
        {"protected": JWS_Protected_Header_4_8_4, "signature": JWS_Signature_4_8_4},
    ],
}
...
class Cookbook08JWSTests(unittest.TestCase):
    def test_4_1_signing(self):
        ...
        protected = base64url_decode(JWS_Protected_Header_4_1_2).decode("utf-8")
    ...
    def test_4_2_signing(self):
        plaintext = base64url_decode(Payload_plaintext_b64_4)
        protected = base64url_decode(JWS_Protected_Header_4_2_2).decode("utf-8")
        pub_key = jwk.JWK(**RSA_Public_Key_3_3)
        pri_key = jwk.JWK(**RSA_Private_Key_3_4)
        s = jws.JWS(payload=plaintext)
        s.add_signature(pri_key, None, protected)
    ...
    def test_4_3_signing(self):
        plaintext = base64url_decode(Payload_plaintext_b64_4)
        protected = base64url_decode(JWS_Protected_Header_4_3_2).decode("utf-8")
    ...
    def test_4_4_signing(self):
        plaintext = base64url_decode(Payload_plaintext_b64_4)
        protected = base64url_decode(JWS_Protected_Header_4_4_2).decode("utf-8")
    ...
    def test_4_6_signing(self):
        plaintext = base64url_decode(Payload_plaintext_b64_4)
        protected = base64url_decode(JWS_Protected_Header_4_6_2).decode("utf-8")
    ...
    def test_4_8_signing(self):
        ...
        s = jws.JWS(payload=plaintext)
        # 4_8_2
        protected = base64url_decode(JWS_Protected_Header_4_8_2).decode("utf-8")
        ...
        # 4_8_4
        protected = base64url_decode(JWS_Protected_Header_4_8_4).decode("utf-8")
...
JWE_general_5_1_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_1_3}],
...
JWE_general_5_2_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_2_3}],
...
JWE_Encrypted_Key_5_3_3 = "d3qNhUWfqheyPp4H8sjOWsDYajoej4c5Je6rlUtFPWdgtURtmeDV1g"
...
JWE_Encrypted_Key_5_4_3 = "0DJjBXri_kBcC46IkU5_Jk9BqaQeHdv2"
...
JWE_general_5_4_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_4_3}],
...
JWE_general_5_7_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_7_3}],
...
JWE_general_5_9_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_9_3}],
...
JWE_general_5_10_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_10_3}],
...
JWE_general_5_11_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_11_3}],
...
JWE_general_5_12_5 = {
    "recipients": [{"encrypted_key": JWE_Encrypted_Key_5_12_3}],
...
class Cookbook08JWETests(unittest.TestCase):
    def test_5_1_encryption(self):
        ...
        e = jwe.JWE(plaintext, protected, algs=jwe.default_allowed_algs + ["RSA1_5"])
